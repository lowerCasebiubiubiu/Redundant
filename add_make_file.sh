...
echo ''>$m_change
echo  $basepath
python  $basepath/mkfiles.py $2 $3#类头  类数量
python  $basepath/move_files.py $1 $basepath/class $4
...
echo 'm文件更新总数:'$msum
mkdir $basepath/classLog
mv $basepath/class $basepath/classLog/class$now_time
